...
const contacts = [
  {
    ...
    desc: 'Lorem ipsum dolor sit amet consectetur, adipisicing elit. Sit nisi laboriosam maiores tenetur sint fugit!',
  },
  {
    name: 'FONDJO Gilres',
    image: 'images/profile.jpg',
  ...
  {
    name: 'KAMGUAINDO FOGANG Bernard',
    image: 'images/profile.jpg',
    desc: 'Lorem ipsum dolor sit amet consectetur, adipisicing elit. Sit nisi laboriosam maiores tenetur sint fugit!',
  },
  {
    name: 'MAYO KEMTEU Livine Heimlich',
    image: 'images/profile.jpg',
    desc: 'Lorem ipsum dolor sit amet consectetur, adipisicing elit. Sit nisi laboriosam maiores tenetur sint fugit!',
  },
];
...
const Contact = () => {
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      axios
        .post(
          apiURL + '/raspberry/stateget?id=' + user.id,
          {},
          {
            headers: {
              Authorization: token,
  ...
  return (
    <div>
      ...
      <Box display={'flex'} flexWrap={'wrap'} justifyContent={'center'} gap={3}>
        {contacts.map((el,i)=>{
          return <ActionAreaCard key={i} desc={el.desc} name={el.name} image={el.image}/>
        })}
      </Box>
    </div>
  );
